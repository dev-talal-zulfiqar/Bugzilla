...
User.create(name: 'Talal Quality Assured', email: 'talal.qa@gmail.com', role: 'software_quality_assurance', password: '123456')
...
Bug.create(title: 'Demo Bug 1', description: 'description for Bug', bug_type: 'bug', status: 'opened', created_by_id: '3', project_id: '1')
Bug.create(title: 'Demo Bug 2', bug_type: 'bug', status: 'opened', created_by_id: '3', project_id: '1')
Bug.create(title: 'Demo Bug 3', description: 'description for Bug', bug_type: 'bug', status: 'opened', created_by_id: '3', project_id: '2')
Bug.create(title: 'Demo Bug 4', bug_type: 'bug', status: 'opened', created_by_id: '3', project_id: '2')
